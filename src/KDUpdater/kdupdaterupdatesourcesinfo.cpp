...
/*!
   ...
   This signal is emitted whenever the contents of this UpdateSourcesInfo is refereshed, usually from with in the refresh() slot.
*/
...
/*!
   Returns a pointer to the update target for which this class manages update sources.
*/
...
/*!
   Explicit set the modified state. See also the \a isModified method.
*/
...
/*!
   Specifies the name of the UpdateSources.xml file that this class referred to.
